...
export const toursData: Tour[] = [
  ...
  },
  {
    ...
    highlights: [
      "White-sand beaches with turquoise Indian Ocean waters",
      "Half-day spice farm tour — see cloves, vanilla, and nutmeg",
      "Sunset dhow cruise along the Zanzibar coastline",
      "UNESCO Stone Town walking tour",
      "Optional snorkelling and dolphin watching",
      "Fresh Swahili seafood cuisine throughout",
    ],
    itinerary: [
      {
        day: 1,
        ...
        description:
          "Fly into Zanzibar International Airport (direct from Nairobi, 1 hour). Transfer to your beach hotel on the north or east coast. Spend the afternoon settling in and taking your first walk on the beach. Welcome dinner at the hotel featuring fresh Swahili seafood.",
        meals: "Dinner",
        accommodation: "Beach Hotel, Zanzibar",
      },
      {
        day: 2,
        title: "Stone Town Cultural Tour",
        description:
          "A half-day guided walking tour through Zanzibar's UNESCO-listed Stone Town — a labyrinth of narrow alleys, ancient mosques, Swahili doorways, and spice markets. Visit the Old Fort, the Palace Museum, and the poignant Slave Memorial. Afternoon free at the beach. Sunset from the famous Africa House terrace.",
        meals: "Breakfast",
        accommodation: "Beach Hotel, Zanzibar",
      },
      {
        day: 3,
        title: "Spice Farm Tour & Sunset Dhow Cruise",
        description:
          "Morning spice farm tour to discover where cloves, cinnamon, vanilla, cardamom, and nutmeg grow in their natural environment. Learn about Zanzibar's rich trading history as a spice island. Return for lunch, then free afternoon. At dusk, board a traditional wooden dhow for a sunset cruise along the coast — sundowners, fresh fruit, and the Stone Town skyline glowing in the last light.",
        meals: "Breakfast, Lunch",
        accommodation: "Beach Hotel, Zanzibar",
      },
      {
        day: 4,
        title: "Beach Day — Snorkelling & Water Sports",
        description:
          "A full free day at the beach. Optional activities include snorkelling at Mnemba Atoll (one of East Africa's finest dive sites), dolphin watching at Kizimkazi, kite surfing, or a day trip to the Prison Island to see giant Aldabra tortoises. Dinner at a beachfront restaurant under the stars.",
        meals: "Breakfast",
        accommodation: "Beach Hotel, Zanzibar",
      },
      {
        ...
        description:
          "Final morning at leisure — breakfast on your terrace, one last swim. Hotel check-out and transfer to the airport for your onward flight.",
        meals: "Breakfast",
        accommodation: "N/A — Departure day",
      },
    ],
    inclusions: [
      "Return flights Nairobi–Zanzibar (economy)",
      "4 nights beach hotel accommodation",
      "Meals as specified",
    ...
    exclusions: [
      ...
      "Travel insurance",
      "Optional water sports and excursions",
    ...
    faqs: [
      {
        question: "Which part of Zanzibar do you use for accommodation?",
        answer:
          "We prefer the north coast (Nungwi/Kendwa) for its calm, swimmable waters year-round and vibrant atmosphere, or the east coast (Paje/Bwejuu) for a quieter, more secluded experience.",
      },
      {
        question: "Can this be combined with a safari?",
        answer:
          "Absolutely — this is one of our most popular combinations. We offer the 6-Day Honeymoon Mara + Zanzibar package, and can build bespoke safari-to-beach itineraries of any length.",
      },
      {
        question: "Is Zanzibar safe to visit?",
        answer:
          "Zanzibar is a very safe, welcoming destination. It is a predominantly Muslim island so we ask guests to dress modestly when in towns and villages. On the beaches, normal beach attire is perfectly appropriate.",
      },
    ],
    featured: true,
    best_seller: false,
