...
export const destinationsData: DestinationFull[] = [
  ...
  },
  {
    ...
    country: "Kenya",
    region: "Kenya Coast",
    short_description: "Kenya's ancient coastal city — history, culture, and white-sand beaches on the Indian Ocean.",
    long_description: "",
    ...
    about:
      "Mombasa is Kenya's oldest city and its only major port — a vibrant, multicultural hub where centuries of Swahili, Arab, Portuguese, and British influence have left an extraordinary cultural imprint. At its heart lies the UNESCO-listed Old Town, a labyrinth of carved doorways, mosques, and bustling spice markets that feels timeless against the backdrop of the Indian Ocean. Fort Jesus, built by the Portuguese in 1593 and now a World Heritage Site, stands guard over the harbour. Beyond the city, Mombasa's coastline stretches north and south — Bamburi Beach to the north offers world-class resorts, water sports, and the famous glass-bottom boat reef tours, while the south coast's quieter shores include Diani Beach. Mombasa is the natural gateway to Kenya's coast and an ideal complement to any upcountry safari.",
    highlights: [
      "Fort Jesus — UNESCO World Heritage Site and 16th-century Portuguese fortress",
      "Mombasa Old Town — carved doorways, mosques, and Swahili street life",
      "Bamburi Beach — white sand, clear water, and world-class resorts",
      "Haller Park — giraffes, hippos, and crocodiles in a reclaimed quarry ecosystem",
      "Blue Ocean watersports — PADI diving, jet skiing, glass-bottom boat rides",
      "Mama Ngina Waterfront and Likoni Ferry — authentic coastal city experience",
    ],
    tour_slugs: ["3-nights-sarova-whitesands"],
  },
  {
    id: "6",
    slug: "diani-beach",
