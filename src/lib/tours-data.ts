...
export const toursData: Tour[] = [
  ...
  },
  {
    id: "12",
    slug: "2-nights-meru",
    title: "3 Days in Meru National Park — Kenya's Hidden Gem",
    summary:
      "Kenya's best-kept safari secret — the park that inspired Born Free, home to the Big Five, 300+ bird species, and two of East Africa's most extraordinary eco-lodges. Meru rewards those who venture off the beaten track.",
    ...
    destinations: ["meru"],
    highlights: [
      "Meru National Park — the setting of Joy Adamson's Born Free and home to Elsa the Lioness",
      "Elsa's Kopje — award-winning eco-lodge built into a rocky inselberg with panoramic park views",
      "Rhino River Camp — intimate riverside luxury with a pool in the forest canopy",
      "Big Five including rare white rhino at the Meru Rhino Sanctuary",
      "Diverse ecosystems: riverine forests, open plains, swamps, and the Tana River",
      "Over 300 bird species — a paradise for birders",
      "Cultural visits to local Borana and Samburu communities",
    ],
    itinerary: [
      {
        day: 1,
        ...
        description:
          "Depart Nairobi at 7:00 AM for the scenic 6–7 hour drive (350 km) northeast to Meru National Park — a journey through the fertile slopes of Mount Kenya and into the vast, lush parklands of Eastern Kenya. Arrive in the early afternoon and check in at Elsa's Kopje or Rhino River Camp. Both properties are among Kenya's most celebrated eco-lodges: Elsa's Kopje is perched on a rocky inselberg with sweeping views over the park immortalised by Joy Adamson's Born Free, while Rhino River Camp sits beside a rushing forest river with a pool nestled in the canopy. After settling in and lunch, take a late afternoon game drive through the park's varied landscapes — dense riverine forests give way to open plains where elephant herds, lion, leopard, and diverse antelope roam freely. Return to the lodge for a campfire dinner under an immense, unlit sky.",
        meals: "Lunch, Dinner",
        accommodation: "Elsa's Kopje or Rhino River Camp, Meru National Park",
      },
      {
        day: 2,
        title: "Full Day in Meru National Park",
        description:
          "An early morning game drive as the mist lifts from the riverine forests — the ideal time for buffalo, giraffe, and the elusive leopard. Return to the lodge for a relaxed breakfast. Mid-morning, drive to the Meru Rhino Sanctuary — one of Kenya's most significant rhino breeding and protection programs — for a rare chance to observe white rhino on foot with an armed ranger, or take a guided nature walk along one of the park's many rivers. After lunch at the lodge, spend the afternoon at leisure — swim in the pool, watch birds from your veranda, or join an optional drive to the Tana River for some catch-and-release fishing. The evening ends with a sundowner watching the Meru inselbergs glow gold, followed by dinner at the lodge.",
        meals: "Breakfast, Lunch, Dinner",
        accommodation: "Elsa's Kopje or Rhino River Camp, Meru National Park",
      },
      {
        ...
        title: "Morning Game Drive and Return to Nairobi",
        description:
          "After breakfast, a short morning game drive on your way out of the park — one final circuit through the landscape that inspired one of the great wildlife stories ever told. Depart Meru for the return drive to Nairobi, arriving in the late afternoon.",
        meals: "Breakfast",
        accommodation: "N/A — Return day",
      },
    ],
    inclusions: [
      "2 nights accommodation at Elsa's Kopje or Rhino River Camp",
      "Full-board meals — breakfast, lunch, and dinner daily",
      "All game drives in a 4WD safari vehicle",
      "Meru National Park entry fees",
      "Meru Rhino Sanctuary drive or guided nature walk",
      "Professional, licensed English-speaking guide",
      "Return road transfers from Nairobi",
    ],
    exclusions: [
      ...
      "Kenya visa fees",
      "Travel insurance (strongly recommended)",
      "Tana River fishing excursion (optional)",
      "Cultural village visits (optional, additional cost)",
      "Alcoholic beverages",
      "Tips and gratuities",
      "Items of a personal nature",
    ],
    gallery: [
      "/images/tours/meru/meru-elephants-inselberg.jpg",
      "/images/tours/meru/meru-elsas-kopje-dinner.jpg",
      "/images/tours/meru/meru-elsas-kopje-villa.jpg",
      "/images/tours/meru/meru-park-landscape.jpg",
      "/images/tours/meru/meru-sundowner-safari.jpg",
      "/images/tours/meru/meru-lodge-sunset-view.jpg",
      "/images/tours/meru/meru-rhino-river-dining.jpg",
      "/images/tours/meru/meru-rhino-river-aerial.jpg",
      "/images/tours/meru/meru-rhino-river-pool.jpg",
    ],
    faqs: [
      {
        question: "Why is Meru called Kenya's hidden gem?",
        answer:
          "Meru sees a fraction of the visitors of the Maasai Mara or Amboseli, yet holds the same Big Five and a far more diverse range of ecosystems — from dense riverine forest to open savanna to swamps and rivers. The result is an authentic, uncrowded safari experience that many seasoned travellers consider among Kenya's very best. Its lodges, Elsa's Kopje in particular, are consistently ranked among Africa's finest.",
      },
      {
        question: "What is the Born Free connection?",
        answer:
          "Meru National Park is where game warden George Adamson and his wife Joy raised Elsa the lioness and successfully returned her to the wild — the story told in Joy Adamson's 1960 book Born Free and the subsequent film. Elsa's Kopje lodge is built on the kopje (rocky outcrop) where George Adamson camped, and honours her memory. Joy Adamson is buried in the park.",
      },
      {
        question: "Can we see rhino in Meru?",
        answer:
          "Yes. Meru has a dedicated rhino sanctuary managed by the Kenya Wildlife Service and Lewa Wildlife Conservancy. It currently protects both black and white rhino. Game drives within the sanctuary are guided by armed KWS rangers, and rhino sightings are relatively reliable compared to other Kenya parks.",
      },
      {
        question: "Which lodge is better — Elsa's Kopje or Rhino River Camp?",
        answer:
          "Both are exceptional. Elsa's Kopje is more dramatic — perched on a rocky hill with sweeping views and an intimate luxury feel. Rhino River Camp sits in a lush river setting and is ideal for birdwatchers and those seeking a more secluded, forest atmosphere. We recommend Elsa's Kopje for first-time visitors to Meru.",
      },
    ],
    featured: true,
    best_seller: false,
